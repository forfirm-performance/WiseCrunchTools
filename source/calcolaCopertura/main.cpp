...
int main(int argc, char* argv[])
{
   ...
   //Input file del TESTSET
    ...
    for( std::map<long, std::vector<string> >::const_iterator tsi = rTestSet.begin(); tsi != rTestSet.end(); ++tsi){
        ...
        cont=0;
                ...
                if(cont==WISE){
                    ...
                    //num_riga_ts e num_riga_wise
                    num_riga_ts = tsi->first+1;
                    num_riga_wise = wsi->first+1;
    ...
    } // Chiudo ciclo sulla mappa del Test Set
...
// Concatena il vettore in una stringa
